...
function getCurrent(req, res) {
    ...
    let forecast = new WeatherForecast(process.env.NODE_FORECAST_API, 8000, true);

    let latidue = 0;
    let longitude = 0;
    let options = {};
    
    if (req.query && typeof req.query.latitude !== 'undefined' && req.query.latitude !== null){
    ...
    if (req.query && typeof req.query.longitude !== 'undefined' && req.query.longitude !== null){
    ...
    if (req.query && typeof req.query.options !== 'undefined' && req.query.options !== null){
